...
object DataDummy {
    ...
    fun generateDummyMoviesFavorite(): List<MovieFavoriteEntity> {

        val movies = ArrayList<MovieFavoriteEntity>()
    ...
    fun generateDummyTvShowFavorite(): List<TvShowFavoriteEntity> {

        val tv_shows = ArrayList<TvShowFavoriteEntity>()
        tv_shows.add(
